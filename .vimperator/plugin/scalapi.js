...
var scalaApiURL = liberator.globalVariables.scalaApiURL || 'http://www.scala-lang.org/api/current/';
if (!liberator.globalVariables.scalaApiCache) {
    let xhr = new XMLHttpRequest();
    let regex = new RegExp('<a href="scala/([^.]+).html" class="tplshow">([^.]+)</a>', 'g');
    ...
    xhr.open('GET', scalaApiURL + 'index.html', true);
    xhr.send(null);
}
